...
**Principal Software Engineer** with 16 years of experience building production-grade systems, developer platforms, and AI-powered runtimes.

I focus on **system design, agent architectures, automation, and reliability** — not just shipping features.
...
- **[agent-runtime-lab](https://github.com/itpixelz/agent-runtime-lab)** — Experimental reference implementation for agent runtime architecture patterns
- **[code-partner](https://github.com/itpixelz/code-partner)** — Claude Code CLI Supervisor for automated coding tasks

## Connect

- [LinkedIn](https://linkedin.com/in/umardraz)
- [Email](mailto:umar@itpixelz.com)
